...
class URRobot(object):
    ...
    def get_robot_mode(self):
        ...
        :return:
        """
        return self.secmon.get_robot_mode()

    def get_tool_data(self):
        """
        get tool data, for analog input
        :return:
        """
        return self.secmon.get_tool_data()

    def get_masterboard_mode(self):
        """
        get robot mode
        :return:
        """
        return self.secmon.get_masterboard_mode()
    ...
    def get_inverse_kin(self,x,qnear,maxPositionError=1e-10,maxOrientationError=1e-10):
        tpose = [round(i, self.max_float_length) for i in x]
        qnear = [round(i, self.max_float_length) for i in qnear]
        tpose = tpose + qnear
        tpose.append(maxPositionError)
        tpose.append(maxOrientationError)

        prog = 'get_inverse_kin(p[{},{},{},{},{},{}],[{},{},{},{},{},{}],{},{})'.format(*tpose)
        self.send_program(prog)
    ...
    def _wait_for_move(self, target, threshold=None, timeout=5, joints=False):
        ...
        if threshold is None:
            ...
            if threshold < 0.0005:  # roboten precision is limited
                threshold = 0.0005
